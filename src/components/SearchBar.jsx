    ...
    <div className="flex flex-col gap-6 p-5">
      <div className="flex items-center justify-between w-full gap-4">
        ...
        <input
          ...
          className="flex-1 text-black font-bold bg-blue-200 rounded-2xl text-center p-2 min-w-[100px] max-w-full md:max-w-2xl md:h-13"
          value={input}
      ...
      {/* Current Weather */}
      <div className="flex flex-col md:flex-row justify-between items-center p-5 bg-blue-300 rounded-xl">
        ...
        <img
          ...
          alt="weather icon"
          className="w-32 h-32 md:w-40 md:h-40 bg-blue-400 rounded-4xl"
        />
      </div>
        ...
        <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-4">
          {forecast.forecastday[0].hour
            ...
            .map((hour, index) => (
              <div
                key={index}
                className="flex flex-col items-center gap-2 p-2 bg-blue-500 rounded-lg"
              >
      ...
      <div className="bg-blue-300 p-4 rounded-xl">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            <div
              key={index}
              className="flex items-center gap-2 p-2 bg-blue-500 rounded-lg"
            >
              <img
                src={item.icon}
                alt={`${item.label} icon`}
